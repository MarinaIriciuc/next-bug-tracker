            ...
            <div className="px-5 flex items-center justify-center">
                <div className="w-full">
                    <p className="text-xl mt-5">Hello, <span
                        className="text-purple-400 font-semibold">{session?.user.username}</span></p>
                    <div className="bg-gray-200 py-3 rounded-lg flex items-center justify-between mt-7">
                        ...
                        <button className="md:block hidden mx-3 focus:outline-none focus:ring-2 focus:ring-gray-700 rounded">
                            <IoMdClose/>
                        </button>
                    </div>
                    <SettingsForm/>
